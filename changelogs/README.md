...
| [T-400](T-400-region-aware-age-logic.md) | region-aware-age-logic | Compliance | In Progress — ST-01 ✅ ST-02 ✅ ST-03 ✅ tests 3-5 PASS 18/18 (2026-07-14); tests 1-2 ⬜ pending Play Console license-testing accounts | 2026-07-14 |
...
| [T-254](T-254-refund-notifications.md) | refund-notifications | Payments | In Progress — ST-01 ✅ código completo POST /android/refund-notification + stub /ios (2026-07-14); ST-02 ⬜ GCP Pub/Sub setup (topic + IAM + push subscription); ST-03 ⬜ Play Console RTDN config (blocked — app no publicada) | 2026-07-14 |
