...
| [T-440](T-440-share-score-backend.md) | share-score-backend | Social | ✅ Done — ST-01 ✅ (2026-06-30); ST-02 ✅ integration test contra Cloud Run dev real + fix imagen Cloudinary 1.19MB→~130KB (2026-07-21) | 2026-07-21 |
...
| [T-406](T-406-iarc-content-rating.md) | iarc-content-rating | Compliance | In Progress — ST-01 ✅ IARC ratings (2026-07-13); ST-02 código ✅ + evidencia de test committeada (2026-07-20, `tests/test_age_verify_router.py`); validación ⬜ pending (Play Store submission + Godot E2E, gate en T-505) | 2026-07-20 |
...
| [T-443](T-443-leaderboard-backend.md) | leaderboard-backend | Game Services | ✅ Done — POST /leaderboard/score (App Check + BQ anomaly) + GET /leaderboard (CDN 5-min) + Firestore leaderboards/{season}/scores/{uid} (2026-07-14); confirmado platform-agnostic para iOS + tests agregados (2026-07-19) | 2026-07-19 |
...
| [AUTH-004](AUTH-004-apple-signin-multi-provider.md) | apple-signin-multi-provider | Auth Backend | ✅ Done — Sign in with Apple (verify_apple_token, JWKS) + provider persistido en users/sessions + fix bug refresh hardcodeaba "google" + tests nuevos (2026-07-18) | 2026-07-18 |
| [PAY-004](PAY-004-apple-purchase-verification.md) | apple-purchase-verification | Payments | ✅ Done — POST /payments/ios/verify real (App Store Server Library, SignedDataVerifier local) + ios/refund-notification (ASSN v2) + platform field en purchases/{doc_id} + tests (2026-07-18) | 2026-07-18 |
| [T-311](T-311-tenjin-share-tracking-link.md) | tenjin-share-tracking-link | External Services | Done (backend scope) — Decision L Option A confirmada por Juan; `_tenjin_share_url()` en share_create con fallback a URL directa hasta que exista el link real de Tenjin; SDK cliente + fraud filtering fuera de este alcance (2026-07-21) | 2026-07-21 |
