...
| [T-400](T-400-region-aware-age-logic.md) | region-aware-age-logic | Compliance | In Progress — ST-01 ✅ backend code completo (2026-07-12); ST-02 ⬜ GCS + MaxMind refresh pipeline (lunes); ST-03 ⬜ test e2e pending T-252 | 2026-07-12 |
