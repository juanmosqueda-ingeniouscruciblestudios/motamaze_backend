...
| [REST-001](REST-001-rest-api-contract.md) | rest-api-contract | Planning | In Progress — ST-01–07 ✅, ST-08 🔴 Stuck (Juan pendiente revisar, deadline 2026-06-24) | 2026-06-19 |
...
| [INFRA-006](INFRA-006-dev-staging-prod-terraform.md) | dev-staging-prod-terraform | Infra/DevOps | In Progress — ST-01 ✅ proyectos GCP creados (billing dev pendiente Juan), ST-02 ✅ módulo Terraform, ST-03 ✅ remote state bucket, ST-04 ⬜ apply dev pendiente billing + INFRA-003. Staging diferido post-lanzamiento. | 2026-06-22 |
| [CI-001](CI-001-cicd-github-actions.md) | cicd-github-actions | Infra/DevOps | In Progress — ST-01 ✅ Dockerfile + workflow DEV+PROD (staging diferido 2026-06-22), ST-02–05 pendientes INFRA-003 (backend repo) | 2026-06-22 |
