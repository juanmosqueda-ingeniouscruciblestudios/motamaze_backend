...
| [INFRA-006](INFRA-006-dev-staging-prod-terraform.md) | dev-staging-prod-terraform | Infra/DevOps | In Progress — ST-01 ✅ proyectos GCP creados (billing pendiente Juan), ST-02 ✅ módulo Terraform, ST-03 ✅ remote state bucket, ST-04 ⬜ apply pendiente billing + INFRA-003 | 2026-06-19 |
| [CI-001](CI-001-cicd-github-actions.md) | cicd-github-actions | Infra/DevOps | In Progress — ST-01 ✅ Dockerfile + workflow build job (ci-templates/), ST-02–05 pendientes INFRA-003 (backend repo) | 2026-06-19 |
