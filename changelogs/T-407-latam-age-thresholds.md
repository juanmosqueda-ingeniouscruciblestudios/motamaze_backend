...
- **PE threshold 14:** Perú es el único país Wave 1 con threshold por debajo de 13 (default). Esto es correcto: la ley peruana explícitamente establece 14 — pero el threshold funciona como "edad mínima donde NO se requiere consentimiento parental", no como "edad mínima de uso". Verificar con T-401 (is_child flag) que la lógica downstream maneja correctamente thresholds por debajo de 13.
